...
const AdminProjectEdit = ({ id }) => {
  ...
  useEffect(() => {
    ...
    formEdit.addEventListener("submit", async (e) => {
      ...
      axios
        .put("http://localhost:3000/projects/" + id, formEdit)
  ...
  <div class="contactadmin__edit">
    <form action=""  id="form--edit" class="form__about">
     ...
     <div class="form-input">
      ...
      <input type="text" class="projectName"  value="${project.name}" />
      </div>
      <div class="form-group">
      <label htmlFor="">GitHub</label> <br />
      <input type="text" class="projectGit" value="${project.hrefgithub}" />
      </div>
      <div class="form-group">
      <label htmlFor="">Preview</label> <br />
      <input type="text" class="projectPre" value="${project.hrefpreview}"  />
      </div>
      <div class="form-group">
      <label htmlFor="">Time</label> <br />
      <input type="text" class="projectTime" value="${project.hrefpreview}" />
      </div>
      <div class="form-group">
      ...
      <input name="" id=""  class="projectCate" value="${project.category}"  />
      </div>
      </div>
